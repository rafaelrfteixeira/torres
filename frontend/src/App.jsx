 ...
 */
const TENANTS_WITH_PREVENTIVAS = ['salvador-norte', 'empresarial-rui-barbosa', 'shopping-guararapes', 'empresarial-cicero-dias', 'empresarial-kronos', 'riomar-kennedy', 'jcpm-trade-center', 'beach-class', 'shopping-recife'];
          ...
          <>
            ...
            <div className="bg-slate-900 border-b border-brand-800 px-6 py-3 text-white flex justify-between items-center sticky top-0 z-40 shadow-md">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => window.dispatchEvent(new Event('open_pwa_install'))}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-brand-600/30 hover:bg-brand-600/50 text-brand-200 border border-brand-500/40 rounded-lg text-xs font-semibold transition-all cursor-pointer shadow-sm"
                  title="Instalar Torres CX no seu dispositivo"
                >
