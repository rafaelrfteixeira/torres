...
export default function FormSelection({ shoppingsMetadata = [] }) {
  ...
  const inspections = [
    {
      id: 'dashboard-sdai',
      title: 'Dashboard SDAI',
      subtitle: 'Acompanhamento das Inspeções',
    ...
    },
    {
      id: 'dashboard-bms',
      title: 'Dashboard BMS',
      subtitle: 'Acompanhamento das Inspeções BMS',
    ...
    const foundInMetadata = shoppingsMetadata.some((s) => s.id === tenant);
    if (foundInMetadata) {
      if (inspection.id === 'sdai' || inspection.id === 'dashboard-sdai') {
        return !!currentShopping.listaSDAI;
      }
      if (inspection.id === 'bms') {
        return !!currentShopping.listaBMS;
      }
      if (inspection.id === 'dashboard-bms') {
        return tenant === 'riomar-aracaju';
      }
    }
    return true;
  });
